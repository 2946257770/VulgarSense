...
class NoSlow : Module() {
    ...
    private val modeValue = ListValue("PacketMode", arrayOf("Vanilla" , "Hyt", "Blink", "Intave", "NCP", "AAC", "AAC5", "Custom","OldIntave","Watchdog","SwitchItem"), "Vanilla")
    ...
    private val customDelayValue = IntegerValue("CustomDelay", 60, 0, 1000, "ms") {
        modeValue.get().equals("custom", true)
    }
