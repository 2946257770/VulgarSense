...
public class Window {
    ...
    public void render(int tick,int mouseX,int mouseY){
        ...
        net.ccbluex.liquidbounce.utils.render.RenderUtils.drawImage(new ResourceLocation("vulgarsense/clickgui/zeroday/" + moduleCategory.getDisplayName() + ".png"), (int) (x+pngX), (int) (y+pngY),pngWidth,pngHeight);
