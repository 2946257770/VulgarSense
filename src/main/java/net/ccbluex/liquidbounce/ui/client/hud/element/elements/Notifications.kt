...
class Notification(
    ...
    private val notifyDir = "vulgarsense/notif/intellj/"
    val height = 30
    ...
    fun drawNotification(index: Int, parent: Notifications.Companion, originalX: Float, originalY: Float): Boolean {
        ...
        if (style.equals("Classic")) {
            val image = ResourceLocation("vulgarsense/ui/" + type.name + ".png")
            //Y-Axis Animation
            if (nowY != realY) {
        ...
        if (style.equals("IntelliJIDEA")) {
            ...
            val pn = ResourceLocation(
                when (type.name) {
                    "SUCCESS" -> "vulgarsense/noti/intellj/checkmark.png"
                    "ERROR" -> "vulgarsense/noti/intellj/error.png"
                    "WARNING" -> "vulgarsense/noti/intellj/warning.png"
                    "INFO" -> "vulgarsense/noti/intellj/info.png"
                    else -> "vulgarsense/error/intellj/error1.png"
                }
            )
        ...
        if (style.equals("TenacityOld")) {
            ...
            val pn = ResourceLocation(
                when (type.name) {
                    "SUCCESS" -> "vulgarsense/noti/SUCCESS.png"
                    "ERROR" -> "vulgarsense/noti/ERROR.png"
                    "WARNING" -> "vulgarsense/noti/WARNING.png"
                    "INFO" -> "vulgarsense/noti/INFO.png"
                    else -> "vulgarsense/error/error1.png"
                }
            )
            //Y-Axis Animation
            if (nowY != realY) {
