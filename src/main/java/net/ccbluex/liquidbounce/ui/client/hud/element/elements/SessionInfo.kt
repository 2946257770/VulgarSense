...
class SessionInfo(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F) : Element(x, y, scale) {
    ...
    override fun drawElement(): Border {
        ...
        if (modeValue.get().equals("3")) {
            ...
            val time: String = String.format("%02dh %02dm %02ds", hour, minute, second)
            ...
            val hytacban = BanChecker.HYT_BAN_LAST_MIN.toString()
            ...
            Fonts.fontSFUI35.drawStringWithShadow("HytAC Bans", 2f, fontRenderer.height * 4 + 0f, Color.WHITE.rgb)
            Fonts.fontSFUI35.drawStringWithShadow(
                "$hytacban",
                127f,
